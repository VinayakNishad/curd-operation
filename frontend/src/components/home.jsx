     ...
     {/* <header className="header">
      ...
      <nav id="side-bar" className={sidebarOpen ? "open" : "close"}>
        ...
        <div className="container">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, sunt perferendis, beatae esse ea eligendi
                itaque voluptate repellat sapiente quis culpa dignissimos ut amet consequuntur corrupti est consectetur
                ipsam minima voluptatibus accusamus dolorem similique!</p>
        </div>
        <div className="container">
            <h2>Services</h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, sunt perferendis, beatae esse ea eligendi
        ...
        <div className="container">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, sunt perferendis, beatae esse ea eligendi
                ...
                <textarea rows="5" placeholder="Describe / Kind of service" required></textarea>
